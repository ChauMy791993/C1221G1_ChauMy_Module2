...
public class CandidateController {
    ...
    FunctionExperience experienceController = new FunctionExperience();
    FunctionFresher fresherController = new FunctionFresher();
    Fun internController = new InternController();
